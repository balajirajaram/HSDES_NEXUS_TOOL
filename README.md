...
## Appendix: BugScout Legacy Reference

This project was merged into the `intel-sandbox/BugScout` repository. The original
BugScout skills/README content is preserved below for reference.
